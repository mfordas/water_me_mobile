...
export const ShowPlantsLists = ({ getPlantsListsForUser, plantsListsData }: PropsFromRedux) => {
  useEffect(() => {
      ...
      <>
        ...
        >
          {plantsListsArray.map((plantsList) => {
            return (
              <View style={styles.plantsListContainer} key={plantsList.id} data-test="plantsListContainer">
