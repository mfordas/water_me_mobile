...
const mockShowPlantsList = jest.fn(() => Promise.resolve(console.log('Plant list loaded')));
...
describe('Should handle update watering action', () => {
  ...
  it('Should emit callback on press event', async () => {
    const updateWateringButtonFunction = component.find(TouchableOpacity).at(0).prop('onPress');
